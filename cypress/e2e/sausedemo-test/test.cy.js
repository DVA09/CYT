...
describe('Swag Labs tests', () => {
    ...
    it('Filter test', () => {
      ...
      .should('have.text', 'Name (A to Z)Name (Z to A)Price (low to high)Price (high to low)')      
    ...
    it('Inventory item test', () => {
      ...
      cy.get('[data-test=add-to-cart-sauce-labs-onesie]').should('have.text', 'Add to cart').and('be.visible')
    })
    ...
    it('Footer test', () => {
      ...
      cy.get('.footer_copy').should('be.visible').and('have.text', '© 2024 Sauce Labs. All Rights Reserved. Terms of Service | Privacy Policy')
    })
